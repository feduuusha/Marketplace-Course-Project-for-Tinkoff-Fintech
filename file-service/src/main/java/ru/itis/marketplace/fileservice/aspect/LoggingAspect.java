package ru.itis.marketplace.fileservice.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(ru.itis.marketplace.fileservice.exception..*)")
    public void exceptionsPointcut() {}
    @Pointcut("within(ru.itis.marketplace.fileservice.service..*)")
    public void servicesPointcut() {}
    @Pointcut("within(ru.itis.marketplace.fileservice.controller.*)")
