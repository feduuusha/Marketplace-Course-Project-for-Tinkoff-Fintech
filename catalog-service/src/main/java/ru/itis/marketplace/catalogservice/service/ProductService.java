...
public interface ProductService {
    ...
    void updateProductById(Long productId, String name, Double price, String description, String status, Long categoryId, Long brandId);
    void deleteProductById(Long id);
    List<Product> findAllProducts(int size, int page, String sortBy, String direction, String status);
    Product createProduct(String name, Double price, String description, Long categoryId, Long brandId);
